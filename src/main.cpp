...
uint256 hashGenesisBlock("0x00000000950f5c3f361e601018719328725b8a7815214fdeb0321d094072c254");
...
const string strMessageMagic = "Netbits Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight == 1)
        nSubsidy = 28500000 * COIN;
    // Subsidy is cut in half every 200000 blocks, which will occur approximately every 1 year
    nSubsidy >>= (nHeight / 200000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 21600; // 6 hours
static const int64 nTargetSpacing = 120; //2min
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000950f5c3f361e601018719328725b8a7815214fdeb0321d094072c254");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1429969429;
        block.nBits    = 486604799;
        block.nNonce   = 3492762237;
        ...
        assert(block.hashMerkleRoot == uint256("0x68fa383896a7336f92dc673d3d3bf77a149ce6707d49abd00a35290afaa0dd2a"));
        block.print();
       //genesis block
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NetbitsMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NetbitsMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running NetbitsMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("NetbitsMiner terminated\n");
        throw;
    }
}
